...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-02-2019 a las 18:41:48
...
--
-- Base de datos: `2aw3_final_trips`
--
CREATE DATABASE IF NOT EXISTS `2aw3_final_trips` DEFAULT CHARACTER SET utf32 COLLATE utf32_spanish_ci;
USE `2aw3_final_trips`;
...
INSERT INTO `users` (`idUser`, `userName`, `password`, `keyWord1`, `keyWord2`) VALUES
(1, 'traveller20', '$2y$10$Jr1OhNpXYmHyA68xDOHpbOBKV/kmRz/j/tVxHC8oUhYBIIrxgR59y', 'travel', 'train'),
(2, 'newYork90', '$2y$10$Jr1OhNpXYmHyA68xDOHpbOBKV/kmRz/j/tVxHC8oUhYBIIrxgR59y', 'step', 'van'),
(3, 'mikel1995', '$2y$10$Jr1OhNpXYmHyA68xDOHpbOBKV/kmRz/j/tVxHC8oUhYBIIrxgR59y', 'astoa', 'makila');
...
--
ALTER TABLE `usertrips`
  MODIFY `idTrip` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
