...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-02-2019 a las 12:55:54
...
SELECT visits.idVisit AS idVisita, visits.date AS Fecha
FROM visits
WHERE visits.plate = pMatricula$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `spMostrarHistorial(Ellos)` (IN `pMatricula` VARCHAR(10))  NO SQL
